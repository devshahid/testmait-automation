...
class Testmait {
  ...
  initGlobals(dir) {
    ...
    if (!this.config.noGlobals) {
      global.Helper = global.testmait_helper = require('./helper');
      global.actor = global.testmait_actor = require('./actor');
      ...
      global.testmait = require('./index'); // load all objects
