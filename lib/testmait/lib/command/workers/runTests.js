...
// Requiring of Testmait need to be after tty.getWindowSize is available.
const Testmait = require(process.env.CODECEPT_CLASS_PATH || '../../testmait');
...
function filterTests() {
  const files = testmait.testFiles;
  mocha.files = files;
  mocha.loadFiles();
