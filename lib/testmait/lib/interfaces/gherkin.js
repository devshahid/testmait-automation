...
const debug = require('debug')('testmait:bdd');
...
module.exports = (text, file) => {
  ...
  suite.afterEach('testmait.after', () => scenario.teardown(suite));
  suite.beforeAll('testmait.beforeSuite', () => scenario.suiteSetup(suite));
  suite.afterAll('testmait.afterSuite', () => scenario.suiteTeardown(suite));
