...
module.exports = async function (path) {
  ...
  const info = {};
  info.codeceptVersion = Testmait.version();
  ...
  output.print('Or ask them on our discussion board: https://testmait.discourse.group/');
  output.print('Please copy environment info when you report issues on GitHub: https://github.com/Testmaition/TestMaiT/issues');
  output.print('***************************************');
};
