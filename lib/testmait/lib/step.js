...
/**
 * Each command in test executed through `TM.` object is wrapped in Step.
 * Step allows logging executed commands and triggers hook before and after step execution.
 * @param {TestMaiT.Helper} helper
 * @param {string} name
 */
class Step {
  static get TIMEOUT_ORDER() {
    return {
      ...
      stepTimeoutHard: 5,
      /**
       * 10-19 - designated for timeouts set from code, 15 is order of TM.setTimeout(t) operation
       */
      codeLimitTime: 15,
      /**
  ...
  constructor(helper, name) {
    /** @member {string} */
    this.actor = 'TM'; // TM = actor
    /** @member {TestMaiT.Helper} */
