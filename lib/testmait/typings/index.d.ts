// Project: https://github.com/codeception/testmait/
...
declare namespace TestMaiT {
  ...
  type MainConfig = {
    /** Pattern to locate TestMaiT tests.
    ...
    helpers?: {
       ...
       *
       * https://testmait.io/helpers/playwright
       *
       * Available commands:
       * ```js
       * I.amOnPage('/');
       ...
       *
       * https://testmait.io/helpers/puppeteer
       *
       * Available commands:
       * ```js
       * I.amOnPage('/');
       ...
       *
       * https://testmait.io/helpers/JSONResponse
       *
       * Available commands:
       * ```js
    ...
    /**
     * Enable TestMaiT plugins.
     *
     * https://testmait.io/plugins/
     *
     * Plugins listen to test events and extend functionality of TestMaiT.
     *
     * Example:
     *
     * ```js
    ...
    noGlobals?: boolean;
    /**
     * [Mocha test runner options](https://mochajs.org/#configuring-mocha-nodejs), additional [reporters](https://testmait.io/reports/#xml) can be configured here.
     *
     * Example:
     *
     * ```js
    ...
    mocha?: any;
    /**
     * [Execute code before](https://testmait.io/bootstrap/) tests are run.
     *
    ...
    /**
     * [Execute code after tests](https://testmait.io/bootstrap/) finished.
     *
     * Can be either JS module file or async function:
     *
     * ```js
    ...
    /**
     * [Execute code before launching tests in parallel mode](https://testmait.io/bootstrap/#bootstrapall-teardownall)
     *
     */
    bootstrapAll?: (() => Promise<void>) | boolean | string;
    /**
     * [Execute JS code after finishing tests in parallel mode](https://testmait.io/bootstrap/#bootstrapall-teardownall)
     */
    teardownAll?: (() => Promise<void>) | boolean | string;

    /** Enable [localized test commands](https://testmait.io/translation/) */
    translation?: string;

    /** Additional vocabularies for [localication](https://testmait.io/translation/) */
    vocabularies?: Array<string>;

    /**
     * [Require additional JS modules](https://testmait.io/configuration/#require)
     *
     * Example:
     * ```
     * require: ["should"]
    ...
    /**
     * Enable [BDD features](https://testmait.io/bdd/#configuration).
     *
    ...
    /**
     * [AI](https://testmait.io/ai/) features configuration.
     */
    ai?: {
      /** OpenAI model to use */
      model?: string;
    ...
    /**
     * Enable full promise-based helper methods for [TypeScript](https://testmait.io/typescript/) project.
  ...
  type StringOrSecret = string | TestMaiT.Secret;
...
declare const actor: TestMaiT.actor;
declare const codecept_actor: TestMaiT.actor;
declare const Helper: typeof TestMaiT.Helper;
declare const testmait_helper: typeof TestMaiT.Helper;
declare const pause: typeof TestMaiT.pause;
declare const within: typeof TestMaiT.within;
declare const session: typeof TestMaiT.session;
declare const DataTable: typeof TestMaiT.DataTable;
declare const DataTableArgument: typeof TestMaiT.DataTableArgument;
declare const testmait: typeof TestMaiT.index;
declare const locate: typeof TestMaiT.Locator.build;
declare function inject(): TestMaiT.SupportObject;
declare function inject<T extends keyof TestMaiT.SupportObject>(name: T): TestMaiT.SupportObject[T];
declare const secret: typeof TestMaiT.Secret.secret;

// BDD
declare const Given: typeof TestMaiT.addStep;
declare const When: typeof TestMaiT.addStep;
declare const Then: typeof TestMaiT.addStep;

declare const Feature: typeof TestMaiT.Feature;
declare const Scenario: TestMaiT.Scenario;
declare const xScenario: TestMaiT.IScenario;
declare const xFeature: TestMaiT.IFeature;
declare function Data(data: any): TestMaiT.IData;
declare function xData(data: any): TestMaiT.IData;
declare function defineParameterType(options: TestMaiT.IParameterTypeDefinition<any>): void;

// Hooks
declare const BeforeSuite: TestMaiT.IHook;
declare const AfterSuite: TestMaiT.IHook;
declare const Background: TestMaiT.IHook;
declare const Before: TestMaiT.IHook;
declare const After: TestMaiT.IHook;
...
declare namespace NodeJS {
  ...
  interface Global extends TestMaiT.Globals {
    codecept_dir: typeof codecept_dir;
    output_dir: typeof output_dir;

    actor: typeof actor;
    testmait_actor: typeof testmait_actor;
    Helper: typeof Helper;
    testmait_helper: typeof testmait_helper;
    pause: typeof pause;
...
declare module 'testmait' {
  export = testmait;
}

declare module 'testmait/helper' {
  export = TestMaiT.Helper;
}
