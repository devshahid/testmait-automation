...
/**
 *  Appium helper extends [Webdriver](http://testmait.io/helpers/WebDriver/) helper.
 ...
 *
 * * `appiumV2`: set this to true if you want to run tests with AppiumV2. See more how to setup [here](https://testmait.io/mobile/#setting-up)
...
class Appium extends Webdriver {
  ...
  _validateConfig(config) {
    ...
    // [TestMaiT compatible] transform host to hostname
   ...
   *
   * @param {TestMaiT.LocatorOrString} locator
